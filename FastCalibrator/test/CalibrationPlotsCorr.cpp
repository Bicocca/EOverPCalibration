...
int main(int argc, char **argv)
{
  ...
  std::string inFileName = gConfigParser -> readStringOption("Input::inFileName");
  bool is2012Calib =  gConfigParser -> readBoolOption("Input::is2012Calib");
  
  bool isEB = gConfigParser -> readBoolOption("Input::isEB");
  bool isMC = gConfigParser -> readBoolOption("Input::isMC");
  
  std::string outputFolder  = gConfigParser -> readStringOption("Output::outputFolder");
  ...
  if( evalStat )
  {
    inFileNameEven = gConfigParser -> readStringOption("Input::inFileNameEven");
    inFileNameOdd  = gConfigParser -> readStringOption("Input::inFileNameOdd");
  }
  ...
  TGraphErrors* g_avgIC_vsPhiFold_EBM;
  TGraphErrors* g_avgIC_vsPhiFold_EBP;
  
  if( isEB == true )
  {
    g_avgIC_vsPhiFold_EBM = new TGraphErrors();
    g_avgIC_vsPhiFold_EBP = new TGraphErrors();
  ...
  if( isEB == true )
  {
    pol0_EBM = new TF1("pol0_EBM","pol0",4.,16.);
    pol0_EBP = new TF1("pol0_EBP","pol0",4.,16.);
  ...
  TH1F* h_spread_crackCorr;
  std::vector<TH1F*> h_spread_vsEta_crackCorr;
  TGraphErrors* g_spread_vsEta_crackCorr;
  
  if( isEB == true )
  {
    h_spread_crackCorr = new TH1F("h_spread_crackCorr","",nBins_spread,spreadMin,spreadMax);
    g_spread_vsEta_crackCorr = new TGraphErrors();
  ...
  TH1F* h_phiAvgICSpread_crackCorr;
  TGraphErrors* g_avgIC_vsPhi_crackCorr;
  
  if( isEB == true )
  {  
    h_phiAvgICSpread_crackCorr = new TH1F("h_phiAvgICSpread_crackCorr","",nBins_spread,spreadMin,spreadMax);
    g_avgIC_vsPhi_crackCorr = new TGraphErrors();
  ...
  TGraphErrors* g_avgIC_vsPhiFold_crackCorr_EBM;
  TGraphErrors* g_avgIC_vsPhiFold_crackCorr_EBP;
  
  if( isEB == true )
  {
    g_avgIC_vsPhiFold_crackCorr_EBM = new TGraphErrors();
    g_avgIC_vsPhiFold_crackCorr_EBP = new TGraphErrors();
  ...
  TH1F* h_stat_crackCorr;
  std::vector<TH1F*> h_stat_vsEta_crackCorr;
  TGraphErrors* g_stat_vsEta_crackCorr;
  TGraphErrors* g_residual_vsEta_crackCorr;
  
  if( isEB == true)
  {
    h_stat_crackCorr = new TH1F("h_stat_crackCorr","",nBins_stat,statMin,statMax);
    g_stat_vsEta_crackCorr = new TGraphErrors();
    g_residual_vsEta_crackCorr = new TGraphErrors();
