...
int main(int argc, char **argv)
{
  ...
  io1.open ("output_runD_10ITER_SISCALIB_ETALINEAR/IC_Run2012ABC_22JanuaryRereco_WZ_Fbrem_EB_SISCALIB_relative.txt");
  ...
  for (int e=0; e<86; e++) {
    ...
    histoEtaRing[e] = new TH1F(histoName,"",50,0.9995,1.0005);
  }
